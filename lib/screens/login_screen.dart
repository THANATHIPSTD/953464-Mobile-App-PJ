...
import 'diary_screen.dart'; // Import the Diary screen
  ...
  Future<void> _authenticate() async {
    try {
      bool didAuthenticate = await auth.authenticate(
        localizedReason: 'Scan fingerprint, face, or use PIN to unlock your diary.',
        biometricOnly: false, 
      );
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton.icon(
                ...
                icon: const Icon(Icons.fingerprint, size: 30, color: Colors.white),
                label: const Text('Unlock', style: TextStyle(fontSize: 20, color: Colors.white)),
